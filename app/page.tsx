...
const socialLinks = [
  { name: "Twitter", icon: FaTwitter, href: "https://x.com/GuacKrc20", color: "bg-blue-400" },
  ...
  { name: "GUAC Swap", icon: ArrowRightLeft, href: "https://swap.guac.fyi/token/guac", color: "bg-green-500" },
]
